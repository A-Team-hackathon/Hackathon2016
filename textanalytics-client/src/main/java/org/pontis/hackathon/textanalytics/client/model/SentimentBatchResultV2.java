...
public class SentimentBatchResultV2   {
  @SerializedName("documents")
  private List<SentimentBatchResultItemV2> documents = new ArrayList<SentimentBatchResultItemV2>();

  @SerializedName("errors")
  private List<ErrorRecordV2> errors = new ArrayList<ErrorRecordV2>();

  public SentimentBatchResultV2 documents(List<SentimentBatchResultItemV2> documents) {
    this.documents = documents;
    return this;
  }

  public SentimentBatchResultV2 addDocumentsItem(SentimentBatchResultItemV2 documentsItem) {
  ...
  **/
  ...
  public List<SentimentBatchResultItemV2> getDocuments() {
    return documents;
  }

  public void setDocuments(List<SentimentBatchResultItemV2> documents) {
    this.documents = documents;
  }

  public SentimentBatchResultV2 errors(List<ErrorRecordV2> errors) {
    this.errors = errors;
    return this;
  }

  public SentimentBatchResultV2 addErrorsItem(ErrorRecordV2 errorsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SentimentBatchResultV2 sentimentBatchResultV2 = (SentimentBatchResultV2) o;
    return Objects.equals(this.documents, sentimentBatchResultV2.documents) &&
        Objects.equals(this.errors, sentimentBatchResultV2.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class SentimentBatchResultV2 {\n");
