...
public class ErrorRecordV2   {
  ...
  public ErrorRecordV2 id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", value = "Input document unique identifier the error refers to.")
  public String getId() {
    return id;
  }
  ...
  public ErrorRecordV2 message(String message) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ErrorRecordV2 errorRecordV2 = (ErrorRecordV2) o;
    return Objects.equals(this.id, errorRecordV2.id) &&
        Objects.equals(this.message, errorRecordV2.message);
  }
